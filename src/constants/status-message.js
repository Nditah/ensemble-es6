...
export const STATUS_MSG = {
  ERROR: {
    ...
    PAYMENT_NOT_PROCESSED: {
      statusCode: 400,
      customMessage:
        "There seems like a problem with the payment, Kindly try again !",
    ...
    INVALID_COMBINATION_IN_ROLE: {
      ...
      customMessage:
        "Please send the valid Role according to belong to user type",
    },
    NULL_INVALID: {
      statusCode: 400,
    ...
    ORDER_PENDING: {
      statusCode: 400,
      customMessage:
        "You have an ongoing order, please complete the order before changing status.",
      type: "ORDER_PENDING",
    },
    PARTNER_BUSY: {
      statusCode: 400,
    ...
    NOT_AUTHORISED: {
      statusCode: 400,
      customMessage:
        "Not Enough Permissions for the user .Kindly contact administrator",
      type: "NOT_AUTHORISED",
    },
    CUSTOMER_ID: {
      statusCode: 400,
  ...
  SUCCESS: {
    RESET_PASSWORD_LINK_SENT: {
      statusCode: 201,
      customMessage:
        "A link has been send to your registered email address to reset your password.",
    ...
    RIDE_SENT_SUCCESSFULLY: {
      statusCode: 201,
      customMessage:
        "Ride request sent successfully. Customer will be notified soon.",
